...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .bloque-texto-g.fah.p-3.p-sm-4.p-md-4
          .col-lg-4
            .bloque-texto-g__img(
    ...
    .row.justify-content-around.align-items-center.mb-5
      figure(data-aos='fade-right')
        img(src='@/assets/curso/temas/T5/img-3.svg', alt='En la figura se observa  todos los aspectos que conforman las políticas de seguridad. ')
    ...
    .row.justify-content-center.mb-5
      .col-lg-8
        ImagenInfografica.color-secundario
          ...
          .tarjeta.fae.p-3(x="7%" y="4%" numero="")
            p.mb-0 Determinar, al interior de la entidad, la persona, rol o dirección que tiene la competencia de formalizar las políticas de seguridad de la información mediante la firma y publicación de las mismas.

          .tarjeta.fae.p-3(x="24%" y="96%" numero="")
            p.mb-0  Identificar el porqué la entidad requiere la creación de la política de seguridad de información y el control al cual hace referencia su implementación.

          .tarjeta.fae.p-3(x="40%" y="4%" numero="")
            p.mb-0  Establecer el alcance ¿A qué población, áreas, procesos o departamentos aplica la política?, ¿Quiénes deben cumplir la política?

          .tarjeta.fae.p-3(x="50%" y="96%" numero="")
            p.mb-0 Definir los responsables y los roles para la implementación, aplicación, seguimiento y autorización de la política.

          .tarjeta.fae.p-3(x="74%" y="4%" numero="")
    ...
    .row.justify-content-center
      .col-lg-10
        .cajon.color-acento-contenido.p-4(style="background-color: #fff4da ")
