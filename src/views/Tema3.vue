...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Anteriormente, se trató el tema de las técnicas de migración de bases de datos de SQL a NoSQL; es momento de conocer los pasos para realizar una migración de información, de MySQL a MongoDB en phpMyAdmin:

    .tarjeta.faf.p-4
      SlyderA(tipo="b")
        .row
          p.mb-4 Se procede a realizar la migración de MySQL a MongoDB en phpMyAdmin
          .col-lg-6.mb-4.mb-lg-0
            figure
              img(src='@/assets/curso/temas/T3/img-4.png', alt='En la imagen se muestra el entorno PhpMyAdmin.')

          .col-lg-6
            figure
              img(src='@/assets/curso/temas/T3/img-5.png', alt='En la imagen se muestra la relación entra las tablas.')
        ...
        .row
          ...
          .col-lg-6.mb-4.mb-lg-0
            figure
              img(src='@/assets/curso/temas/T3/img-6.png', alt='En la imagen se muestra la exportación de base de datos mysql.')

          .col-lg-6
            figure
              img(src='@/assets/curso/temas/T3/img-7.png', alt='En la imagen se muestra el archivo exportado con las tablas.')
        ...
        .row
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/temas/T3/img-8.png', alt='En la imagen se muestra el archivo con las tres colecciones (curso, depto y profesor).')
