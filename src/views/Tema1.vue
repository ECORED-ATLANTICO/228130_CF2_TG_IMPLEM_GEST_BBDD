...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    TabsC.color-acento-contenido.mb-5
      ...
      .py-3.py-md-4(titulo="Paso 2")
        .row.justify-content-around.align-items-center.p-4
          .col-md-7.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/temas/T1/img-4.png', alt='En la figura se observa la creación de la carpeta para las copias de seguridad.')
          .col-md-5
      ...
      .py-3.py-md-4(titulo="Paso 3")
        .row.justify-content-around.align-items-center.p-4
          .col-md-6.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/temas/T1/img-5.png', alt='En la figura se observa la sintaxis utilizada para crear las copias de seguridad.')
          .col-md-6
      ...
      .py-3.py-md-4(titulo="Paso 4")
        .row.justify-content-around.align-items-center.p-4
          .col-md-6.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/temas/T1/img-6.png', alt='En la figura se observa el archivo creado para realizar las copias de seguridad.')
          .col-md-6
    ...
    .row.mb-5.justify-content-center
      .col-6.col-md-3.mb-5.mb-md-0
        figure
          img(data-aos='fade-right')(src='@/assets/curso/temas/T1/img-7.png', alt='')

      .col-md-9
        AcordionA(tipo="a" clase-tarjeta="tarjeta fac")
          .row(titulo="Paso 1").ms-lg-5
            .col-md-12
    ...
    figure.mb-5
      ...
      figcaption Video: Copia de seguridad de bases de datos
    ...
    .bloque-texto-g.fab.p-3.p-sm-4.p-md-4.mb-5
      .row.m-0.align-items-center.justify-content-between
        .col-lg-3.mb-4.mb-lg-0
          .bloque-texto-g__img(
            data-aos="fade-right",:style="{'background-image':`url(${require('@/assets/curso/temas/T1/img-8.png')})`}"
          )
        .col-lg-8
          .contenedor-dashed.p-3
            .bloque-texto-g1__texto.p-3
      ...
      LineaTiempoC.color-primario(text-small).mb-5
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 2")
          ...
          .row.justify-content-around.align-items-center
            .col-md-6.mb-4.mb-md-0
              figure
                img(src='@/assets/curso/temas/T1/img-10.png', alt='En la figura se muestra como realizar la migración de herramientas en MongoDB 4.4 utilizando la opción ‘conecct’ para conectarse a las bases de datos que tiene MongoDB. ')

            .col-md-6
              figure
                img(src='@/assets/curso/temas/T1/img-11.png', alt='En la figura se muestra el entorno de MongoDBCompass.')
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 3")
          ...
          .row.justify-content-around.align-items-center
            .col-md-6.mb-4.mb-md-0
              figure
                img(src='@/assets/curso/temas/T1/img-12.png', alt='En la figura se muestra un ejemplo seleccionando una bases de datos y realizando el backup generando un archivo y utilizando la opción ‘collection')

            .col-md-6
              figure
                img(src='@/assets/curso/temas/T1/img-13.png', alt='En la figura se muestra un ejemplo seleccionando una bases de datos y realizando el backup utilizando la opción ‘collection’.')
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 4")
          ...
          .row.justify-content-around.align-items-center
            .col-md-6.mb-4.mb-md-0
              figure
                img(src='@/assets/curso/temas/T1/img-14.png', alt='En la figura se observa un ejemplo de migración de herramientas utilizando la opción "Export Collection".')

            .col-md-6
              figure
                img(src='@/assets/curso/temas/T1/img-15.png', alt='En la figura se observa un ejemplo de migración de herramientas utilizando la opción "Export Collection" y después seleccionando la opción "Select Fields".')
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 5")
          ...
          .col-md-6.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/temas/T1/img-16.png', alt='En la figura se observa un ejemplo de migración de herramientas utilizando la opción "Select output" junto con la opción "csv".')
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 6")
          ...
          .col-md-6.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/temas/T1/img-17.png', alt='En la figura se observa un ejemplo de migración de herramientas creando en el escritorio del computador una carpeta en donde se va guardar el archivo dando clic en "Export".')
